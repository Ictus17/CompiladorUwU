...
public class Histogram {
    ...
    private BufferedImage getImage() {
        return ImageManager.openImageBI();
    ...
    public ChartPanel createChartPanel() {
        ...
        // chart
        JFreeChart chart = ChartFactory.createHistogram("Histograma", "Numero de pixeles",
            "Colores", dataset, PlotOrientation.VERTICAL, true, true, false);
